---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-products, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-products`.
...
- Checkout local: `app-community/modules/controleonline/ui-products`
