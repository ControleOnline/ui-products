...
- A tela de distribuicao de vitrines de preco deve ser uma listagem `DefaultTable` sobre o store `product_showcase_items`; filtros, busca, ordenacao, paginacao, resumo e loading pertencem ao store/DefaultTable, nao a cards, chips ou listas locais na tela.
